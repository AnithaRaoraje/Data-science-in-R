...
#-------------------------------------------------------------------------------
# 1. After splitting the data frame into train and test sets, build a simple 
...
model_temp <- glm(Region ~ AvgTemperature,data=train_temp,family = 'binomial')

summary(model_temp)

#-------------------------------------------------------------------------------
# 2. After splitting the data frame into train and test sets, build a simple 
...
model_churn <- glm(Churn ~ MonthlyCharges,data=train_churn,family = 'binomial')

summary(model_churn)

#-------------------------------------------------------------------------------
# 3. After splitting the data frame into train and test sets, build a simple 
...
model_pharma <- glm(DrugID ~ Age,data = train_pharma,family = 'binomial')
