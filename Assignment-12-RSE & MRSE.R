...
summary(model_temp)$sigma # sqrt(deviance(model_temp)/df.residual(model_temp))
#-------------------------------------------------------------------------------
...
summary(model_placement)$r.squared

summary(model_placement)$sigma
...
summary(model_pharma)$r.squared

summary(model_pharma)$sigma
